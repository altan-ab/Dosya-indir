...
*/
  ...
  //input dosya seçilince çağrılan fonk.
  ...
  //form submit olunca çağrılan fonk.
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <input
        type="file"
        id="file-selector"
        accept=".pdf, .jpg, .jpeg, .png" //accept ile belirli dosya türleri kabul edilir.
        required //input zorunlu olduğunu belirtir
        multiple //birden fazla dosya seçilmesine izin verir.
        onChange={handleFileChange} //Dosya seçimi değiştiğinde handleFileChange çalışır
      />
